...
from .views import home, seleccionar_plan, logout_view, perfil, inventario_view, agregar_producto, editar_producto, eliminar_producto, agregar_lote_producto, detalle_producto, editar_lote, eliminar_lote, retirar_lote, descargar_plantilla_ventas, procesar_ventas_archivo
